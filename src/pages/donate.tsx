...
const DonatePage = () => {
    const [donationMountID, setDonationMountID] = React.useState();
                        ...
                        <div className="h-full w-full">
                            <div className="mx-auto flex h-full min-h-[75vh] w-3/4 flex-row items-center justify-center">
                                ...
                                >
                                    ...
                                    >
                                        Cùng nhau hành động ngay bây giờ, mọi
                                        đóng góp của bạn đều mang lại sự thay
                                    ...
                                    >
                                        <button
                                            ...
                                            className="buttonLoginAtNavAndDonate mx-auto w-3/4 border-none p-4 text-base font-bold md:w-[35%] md:p-6"
                                        >
                                            QUYÊN GÓP NGAY
                                        </button>
                                    </motion.div>
                            ...
                            <div className="relative w-screen bg-white p-12 text-center md:w-auto">
                                ...
                                <div>
                                    ...
                                    <span className="text-2xl font-semibold text-[#ed6a5a] underline ">
                                        {/* {dataMount[donationMountID]}K */}K
                                    </span>
                                </div>
                                <div className="mt-4">
                                    <button className="MoreBtn w-2/3 md:w-1/2">
                                        QUYÊN GÓP NGAY
                                    </button>
                                </div>
                                {/* X close */}
                ...
                return (
                    ...
                    >
                        ...
                        <div
                         ...
                         0.355, 1)] relative left-0 right-0 mb-5 flex w-full flex-col items-center rounded bg-white p-12 transition-all duration-500 before:absolute before:left-[10px] before:bottom-[10px] before:h-0 before:w-0 before:border-t-[24px] before:border-r-0 before:border-b-0 
